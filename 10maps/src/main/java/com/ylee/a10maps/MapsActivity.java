...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng shingu = new LatLng(37.448, 127.169);
        LatLng shingucross = new LatLng(37.446647, 127.167272);
        LatLng bus1 = new LatLng(37.469681, 127.126755);
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
        ...
        mMap.addMarker(new MarkerOptions().position(bus1).title("신구 우리학교"));
