...
public class MainActivity extends AppCompatActivity {
    ...
    String xmlbook = "<?xml version=\"1.0\"?>\n" +
            "<catalog>\n" +
            "   <book id=\"bk101\">\n" +
    ...
    public void parseXMLbooks(String odata){
       ...
       Float price=0.0f;
            ...
            while(eventType != XmlPullParser.END_DOCUMENT){
                if(eventType == XmlPullParser.START_DOCUMENT){
                    ...
                    if(fxml.equals("author")){
                        ...
                        eventType = xpp.next();
                        if(eventType == XmlPullParser.TEXT){
                            String sprice = xpp.getText();
                            price = Float.parseFloat(sprice);
                            SBooks abook = new SBooks(author, title, price);
        ...
        for(int i=0; i<BooksArray.size(); ++i){
            ...
            presult += "저자 " + abook.author + "제목:" + abook.title +
                    "가격: " + price +"$\n";
        }
    ...
    public void parseXMLforecast(String odata){
        ...
        String supdates=null, stemperature = null, shumidity = null;
            ...
            while(eventType != XmlPullParser.END_DOCUMENT){
                if(eventType == XmlPullParser.START_DOCUMENT){
                    ...
                    if(fxml.equals("temperature")){
                        ...
                        supdates = xpp.getAttributeValue(null, "from");
                    }else if(fxml.equals("humidity")){
                        shumidity = xpp.getAttributeValue(null, "value" );
                        presult += supdates + "temperature=" + stemperature + " humdity=" + shumidity+ "\n";
                    }
                }
    ...
    public void parseXMLforecastYlee(String odata){
        if(odata == null){
            textView.setText("예보데이터 없음");
        }
        String presult = "Forecast:\n";
